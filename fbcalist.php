...
<body>
    ...
    try {
        ...
        $stmt = $conn->prepare("SELECT * FROM fbcasubjects");
        $stmt->execute();
        $subjects = $stmt->fetchAll();

        // Display data in a table
        echo "<h2>FBCA Subjects List</h2>";
        echo "<table>";
    ...
    <script>
        function editSubject(id) {
            ...
            window.location.href = "editfbca.php?id=" + id;
        }

        function removeSubject(id) {
            // Redirect or handle removal logic here
            window.location.href = "removefbca.php?id=" + id;
        }
    </script>
</body>
