...
try {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit'])) {
        ...
        $sql = "UPDATE sbcomsubjects SET subject_code=:subject_code, subject_name=:subject_name, faculty_name=:faculty_name WHERE id=:subject_id";
        ...
        $stmt = $conn->prepare("SELECT * FROM sbcomsubjects WHERE id=:subject_id");
        $stmt->bindParam(':subject_id', $subject_id);
        $stmt->execute();
