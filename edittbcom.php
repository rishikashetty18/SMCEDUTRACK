...
try {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit'])) {
        ...
        $sql = "UPDATE tbcomsubjects SET subject_code=:subject_code, subject_name=:subject_name, faculty_name=:faculty_name WHERE id=:subject_id";
        ...
        $stmt = $conn->prepare("SELECT * FROM tbcomsubjects WHERE id=:subject_id");
        $stmt->bindParam(':subject_id', $subject_id);
        $stmt->execute();
